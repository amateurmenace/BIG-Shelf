...
export const Role2PermissionMap: {
  ...
  [OrganizationRoles.BASE]: {
    ...
    [PermissionEntity.room]: [PermissionAction.read],
  ...
  // BIG customization: MEMBER role — same permission set as SELF_SERVICE (a
  // standard booking user who can reserve items/rooms and take custody).
  [OrganizationRoles.MEMBER]: {
    ...
    [PermissionEntity.booking]: [
      ...
      PermissionAction.checkout,
      PermissionAction.checkin,
      PermissionAction.delete, // Delete own draft bookings only.
      PermissionAction.archive,
      PermissionAction.manageAssets,
      PermissionAction.manageKits,
      PermissionAction.cancel,
